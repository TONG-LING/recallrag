...
- top results:
  - rank 1: `zh_doc_002.md::c0002` score=0.697217 cov=0.566 section=中文复杂检索文档 > 关
  - rank 2: `zh_doc_002.md::c0001` score=0.694728 cov=0.222 section=中文复杂检索文档 > 背景材料2
  - rank 3: `zh_doc_002.md::c0000` score=0.681444 cov=0.207 section=
  - rank 4: `zh_doc_002.md::c0004` score=0.650895 cov=0.242 section=中文复杂检索文档 > 关键材料
  - rank 5: `zh_doc_002.md::c0003` score=0.612916 cov=0.578 section=中文复杂检索文档 > 关键材料
...
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_004.md::c0008` score=0.717972 cov=0.576 section=中文复杂检索文档 > 关键材料
  - rank 2: `zh_doc_004.md::c0004` score=0.693735 cov=0.112 section=中文复杂检索文档 > 背景材料1
  - rank 3: `zh_doc_004.md::c0000` score=0.686201 cov=0.116 section=
  - rank 4: `zh_doc_004.md::c0001` score=0.686121 cov=0.079 section=中文复杂检索文档 > 背景材料1
  - rank 5: `zh_doc_004.md::c0007` score=0.675803 cov=0.463 section=中文复杂检索文档 > 背景材料2
...
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_007.md::c0004` score=0.797595 cov=0.137 section=中文复杂检索文档 > 补充材料2
  - rank 2: `zh_doc_007.md::c0001` score=0.771182 cov=0.45 section=中文复杂检索文档 > 背景材料2
  - rank 3: `zh_doc_007.md::c0000` score=0.730399 cov=0.203 section=
  - rank 4: `zh_doc_007.md::c0002` score=0.716092 cov=0.648 section=中文复杂检索文档 > 关键材料
  - rank 5: `zh_doc_007.md::c0003` score=0.702773 cov=0.339 section=中文复杂检索文档 > 关键材料
...
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_008.md::c0001` score=0.739864 cov=0.33 section=中文复杂检索文档 > 背景材料1
  - rank 2: `zh_doc_008.md::c0004` score=0.682045 cov=0.097 section=中文复杂检索文档 > 补充材料2
  - rank 3: `zh_doc_008.md::c0003` score=0.602055 cov=0.421 section=中文复杂检索文档 > 关键材料
  - rank 4: `zh_doc_008.md::c0002` score=0.601372 cov=0.623 section=中文复杂检索文档 > 关键材料
  - rank 5: `zh_doc_008.md::c0000` score=0.555801 cov=0.068 section=
...
- best_topk_coverage: 0.423
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_057.md::c0000` score=0.722102 cov=0.214 section=
  - rank 2: `zh_doc_057.md::c0007` score=0.708075 cov=0.228 section=中文复杂检索文档 > 补充材料1
  - rank 3: `zh_doc_057.md::c0004` score=0.700332 cov=0.228 section=中文复杂检索文档 > 背景材料1
  - rank 4: `zh_doc_057.md::c0005` score=0.698119 cov=0.423 section=中文复杂检索文档 > 背景材料2
  - rank 5: `zh_doc_057.md::c0001` score=0.640527 cov=0.206 section=中文复杂检索文档 > 背景材料1
...
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_067.md::c0001` score=0.653366 cov=0.646 section=中文复杂检索文档 > 背景材料2
  - rank 2: `zh_doc_067.md::c0000` score=0.637067 cov=0.018 section=
  - rank 3: `zh_doc_067.md::c0003` score=0.586366 cov=0.009 section=中文复杂检索文档 > 补充材料2
  - rank 4: `zh_doc_067.md::c0002` score=0.543221 cov=0.39 section=中文复杂检索文档 > 关键材料
  - rank 5: `zh_doc_011.md::c0002` score=0.385384 cov=0.0 section=中文复杂检索文档 > 关键材料
...
| zh002 | zh_long_span_boundary_candidate | False | None | 0.578 | 1 |
| zh003 | zh_long_span_boundary_candidate | False | None | 0.511 | 1 |
| zh004 | zh_long_span_boundary_candidate | False | None | 0.576 | 1 |
| zh005 | zh_long_span_boundary_candidate | True | 2 | 0.661 | 1 |
| zh006 | zh_long_span_boundary_candidate | False | None | 0.605 | 1 |
| zh007 | zh_long_span_boundary_candidate | False | None | 0.648 | 1 |
| zh008 | zh_long_span_boundary_candidate | False | None | 0.623 | 1 |
...
| zh057 | zh_long_span_boundary_candidate | False | None | 0.423 | 1 |
