...
### zh015_holdout — zh_long_span_boundary_candidate
- question: 做胃镜需要注意什么
- gold: `zh_doc_015.md > 关键材料`
- best_topk_coverage: 0.462
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_015.md::c0006` score=0.73997 cov=0.433 section=中文复杂检索文档 > 关键材料
  - rank 2: `zh_doc_015.md::c0008` score=0.714495 cov=0.326 section=中文复杂检索文档 > 关键材料
  - rank 3: `zh_doc_015.md::c0010` score=0.696711 cov=0.073 section=中文复杂检索文档 > 补充材料1
  - rank 4: `zh_doc_015.md::c0007` score=0.693919 cov=0.286 section=中文复杂检索文档 > 关键材料
  - rank 5: `zh_doc_015.md::c0005` score=0.690109 cov=0.462 section=中文复杂检索文档 > 背景材料2
...
### zh021_holdout — zh_long_span_boundary_candidate
- question: 水表上的数字怎样调整
- gold: `zh_doc_021.md > 关键材料`
- best_topk_coverage: 0.325
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_021.md::c0006` score=0.824123 cov=0.325 section=中文复杂检索文档 > 关键材料
  - rank 2: `zh_doc_021.md::c0005` score=0.812793 cov=0.103 section=中文复杂检索文档 > 背景材料2
  - rank 3: `zh_doc_021.md::c0009` score=0.679312 cov=0.273 section=中文复杂检索文档 > 关键材料
  - rank 4: `zh_doc_021.md::c0011` score=0.674918 cov=0.067 section=中文复杂检索文档 > 补充材料1
  - rank 5: `zh_doc_021.md::c0003` score=0.670248 cov=0.067 section=中文复杂检索文档 > 背景材料1
...
### zh026_holdout — zh_long_span_boundary_candidate
- question: 左肾的区域有疼痛感
- gold: `zh_doc_026.md > 关键材料`
- best_topk_coverage: 0.487
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_026.md::c0005` score=0.815013 cov=0.443 section=中文复杂检索文档 > 关键材料
  - rank 2: `zh_doc_026.md::c0003` score=0.770971 cov=0.341 section=中文复杂检索文档 > 背景材料2
  - rank 3: `zh_doc_026.md::c0004` score=0.765828 cov=0.487 section=中文复杂检索文档 > 关键材料
  - rank 4: `zh_doc_026.md::c0001` score=0.754775 cov=0.121 section=中文复杂检索文档 > 背景材料1
  - rank 5: `zh_doc_026.md::c0000` score=0.737484 cov=0.125 section=
...
### zh035_holdout — zh_long_span_boundary_candidate
- question: 未越狱的iPhone如何清除垃圾文件
- gold: `zh_doc_035.md > 关键材料`
- best_topk_coverage: 0.394
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_035.md::c0008` score=0.728608 cov=0.121 section=中文复杂检索文档 > 补充材料2
  - rank 2: `zh_doc_035.md::c0009` score=0.717667 cov=0.149 section=中文复杂检索文档 > 补充材料2
  - rank 3: `zh_doc_035.md::c0000` score=0.71556 cov=0.141 section=
  - rank 4: `zh_doc_035.md::c0007` score=0.715197 cov=0.125 section=中文复杂检索文档 > 补充材料1
  - rank 5: `zh_doc_035.md::c0005` score=0.705679 cov=0.394 section=中文复杂检索文档 > 关键材料
...
### zh042_holdout — zh_long_span_boundary_candidate
- question: 推荐哪个品牌的户外手电筒
- gold: `zh_doc_042.md > 关键材料`
- best_topk_coverage: 0.411
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_042.md::c0003` score=0.732925 cov=0.411 section=中文复杂检索文档 > 关键材料
  - rank 2: `zh_doc_042.md::c0002` score=0.67968 cov=0.203 section=中文复杂检索文档 > 背景材料2
  - rank 3: `zh_doc_042.md::c0005` score=0.669898 cov=0.277 section=中文复杂检索文档 > 关键材料
  - rank 4: `zh_doc_042.md::c0001` score=0.648263 cov=0.067 section=中文复杂检索文档 > 背景材料1
  - rank 5: `zh_doc_042.md::c0006` score=0.628167 cov=0.107 section=中文复杂检索文档 > 补充材料1
...
### zh045_holdout — zh_long_span_boundary_candidate
- question: 推荐哪个品牌的轻型羽绒服
- gold: `zh_doc_045.md > 关键材料`
- best_topk_coverage: 0.521
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_045.md::c0000` score=0.591711 cov=0.1 section=
  - rank 2: `zh_doc_045.md::c0004` score=0.589423 cov=0.521 section=中文复杂检索文档 > 关键材料
  - rank 3: `zh_doc_045.md::c0013` score=0.574199 cov=0.1 section=中文复杂检索文档 > 补充材料2
  - rank 4: `zh_doc_045.md::c0008` score=0.572346 cov=0.071 section=中文复杂检索文档 > 补充材料1
  - rank 5: `zh_doc_045.md::c0005` score=0.571338 cov=0.134 section=中文复杂检索文档 > 补充材料1
...
### zh049_holdout — zh_long_span_boundary_candidate
- question: 在西安做人流手术大概需要多少钱
- gold: `zh_doc_049.md > 关键材料`
- best_topk_coverage: 0.583
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_049.md::c0000` score=0.75177 cov=0.161 section=
  - rank 2: `zh_doc_049.md::c0005` score=0.750878 cov=0.477 section=中文复杂检索文档 > 关键材料
  - rank 3: `zh_doc_049.md::c0006` score=0.7436 cov=0.217 section=中文复杂检索文档 > 补充材料1
  - rank 4: `zh_doc_049.md::c0003` score=0.702211 cov=0.507 section=中文复杂检索文档 > 关键材料
  - rank 5: `zh_doc_049.md::c0004` score=0.69901 cov=0.583 section=中文复杂检索文档 > 关键材料
...
### zh052_holdout — zh_long_span_boundary_candidate
- question: 生气的时候可以喂奶吗？
- gold: `zh_doc_052.md > 关键材料`
- best_topk_coverage: 0.482
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_052.md::c0004` score=0.691664 cov=0.482 section=中文复杂检索文档 > 关键材料
  - rank 2: `zh_doc_052.md::c0007` score=0.686647 cov=0.123 section=中文复杂检索文档 > 补充材料2
  - rank 3: `zh_doc_052.md::c0002` score=0.677466 cov=0.359 section=中文复杂检索文档 > 背景材料2
  - rank 4: `zh_doc_052.md::c0006` score=0.658351 cov=0.135 section=中文复杂检索文档 > 补充材料1
  - rank 5: `zh_doc_052.md::c0005` score=0.622084 cov=0.105 section=中文复杂检索文档 > 补充材料1
...
### zh060_holdout — zh_long_span_boundary_candidate
- question: 氨端聚二甲基硅氧烷是否属于硅油
- gold: `zh_doc_060.md > 关键材料`
- best_topk_coverage: 0.27
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_060.md::c0009` score=0.658576 cov=0.27 section=中文复杂检索文档 > 背景材料2
  - rank 2: `zh_doc_060.md::c0014` score=0.640066 cov=0.108 section=中文复杂检索文档 > 补充材料1
  - rank 3: `zh_doc_060.md::c0016` score=0.619733 cov=0.125 section=中文复杂检索文档 > 补充材料1
  - rank 4: `zh_doc_060.md::c0012` score=0.614451 cov=0.145 section=中文复杂检索文档 > 关键材料
  - rank 5: `zh_doc_060.md::c0001` score=0.607269 cov=0.194 section=中文复杂检索文档 > 背景材料1

### zh061_holdout — zh_long_span_boundary_candidate
- question: 中国为何一定要坚守18亿亩耕地红线
- gold: `zh_doc_061.md > 关键材料`
- best_topk_coverage: 0.342
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_061.md::c0009` score=0.770061 cov=0.166 section=中文复杂检索文档 > 补充材料1
  - rank 2: `zh_doc_061.md::c0006` score=0.764344 cov=0.342 section=中文复杂检索文档 > 背景材料2
  - rank 3: `zh_doc_061.md::c0005` score=0.757591 cov=0.116 section=中文复杂检索文档 > 背景材料1
  - rank 4: `zh_doc_061.md::c0010` score=0.753479 cov=0.107 section=中文复杂检索文档 > 补充材料1
  - rank 5: `zh_doc_061.md::c0000` score=0.749376 cov=0.129 section=
...
### zh063_holdout — zh_long_span_boundary_candidate
- question: 哪种花代表着孩子的纯洁
- gold: `zh_doc_063.md > 关键材料`
- best_topk_coverage: 0.526
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_063.md::c0000` score=0.647083 cov=0.107 section=
  - rank 2: `zh_doc_063.md::c0008` score=0.604433 cov=0.289 section=中文复杂检索文档 > 补充材料1
  - rank 3: `zh_doc_063.md::c0009` score=0.600735 cov=0.047 section=中文复杂检索文档 > 补充材料2
  - rank 4: `zh_doc_063.md::c0004` score=0.598103 cov=0.277 section=中文复杂检索文档 > 背景材料2
  - rank 5: `zh_doc_063.md::c0007` score=0.579134 cov=0.526 section=中文复杂检索文档 > 关键材料
...
### zh065_holdout — zh_long_span_boundary_candidate
- question: 什么品牌的制氧机质量比较好
- gold: `zh_doc_065.md > 关键材料`
- best_topk_coverage: 0.581
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_065.md::c0004` score=0.687194 cov=0.416 section=中文复杂检索文档 > 背景材料2
  - rank 2: `zh_doc_065.md::c0005` score=0.686782 cov=0.581 section=中文复杂检索文档 > 关键材料
  - rank 3: `zh_doc_065.md::c0003` score=0.665177 cov=0.165 section=中文复杂检索文档 > 背景材料2
  - rank 4: `zh_doc_065.md::c0006` score=0.662189 cov=0.382 section=中文复杂检索文档 > 关键材料
  - rank 5: `zh_doc_065.md::c0002` score=0.649691 cov=0.154 section=中文复杂检索文档 > 背景材料2
...
### zh068_holdout — zh_long_span_boundary_candidate
- question: 跳鬼步舞的时候，手的动作应该怎么做？
- gold: `zh_doc_068.md > 关键材料`
- best_topk_coverage: 0.553
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_068.md::c0017` score=0.639427 cov=0.15 section=中文复杂检索文档 > 关键材料
  - rank 2: `zh_doc_068.md::c0016` score=0.632594 cov=0.553 section=中文复杂检索文档 > 关键材料
  - rank 3: `zh_doc_068.md::c0001` score=0.575028 cov=0.078 section=中文复杂检索文档 > 背景材料1
  - rank 4: `zh_doc_068.md::c0009` score=0.572844 cov=0.126 section=中文复杂检索文档 > 背景材料1
  - rank 5: `zh_doc_068.md::c0011` score=0.567585 cov=0.075 section=中文复杂检索文档 > 背景材料1

### zh069_holdout — zh_long_span_boundary_candidate
- question: would like的回复方式
- gold: `zh_doc_069.md > 关键材料`
- best_topk_coverage: 0.24
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_069.md::c0012` score=0.77608 cov=0.125 section=中文复杂检索文档 > 补充材料1
  - rank 2: `zh_doc_069.md::c0004` score=0.766172 cov=0.24 section=中文复杂检索文档 > 背景材料1
  - rank 3: `zh_doc_069.md::c0000` score=0.764876 cov=0.125 section=
  - rank 4: `zh_doc_069.md::c0001` score=0.754757 cov=0.125 section=中文复杂检索文档 > 背景材料1
  - rank 5: `zh_doc_069.md::c0005` score=0.752409 cov=0.105 section=中文复杂检索文档 > 背景材料1
...
### zh073_holdout — zh_long_span_boundary_candidate
- question: 三壬行化妆学校的口碑怎么样
- gold: `zh_doc_073.md > 关键材料`
- best_topk_coverage: 0.534
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_073.md::c0002` score=0.781278 cov=0.267 section=中文复杂检索文档 > 背景材料2
  - rank 2: `zh_doc_073.md::c0004` score=0.761921 cov=0.441 section=中文复杂检索文档 > 关键材料
  - rank 3: `zh_doc_073.md::c0003` score=0.760439 cov=0.534 section=中文复杂检索文档 > 关键材料
  - rank 4: `zh_doc_073.md::c0001` score=0.729053 cov=0.076 section=中文复杂检索文档 > 背景材料1
  - rank 5: `zh_doc_073.md::c0000` score=0.679117 cov=0.086 section=
...
### zh080_holdout — zh_long_span_boundary_candidate
- question: ipad可以连接打印机吗
- gold: `zh_doc_080.md > 关键材料`
- best_topk_coverage: 0.545
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_080.md::c0000` score=0.725744 cov=0.206 section=
  - rank 2: `zh_doc_080.md::c0003` score=0.714971 cov=0.181 section=中文复杂检索文档 > 背景材料1
  - rank 3: `zh_doc_080.md::c0009` score=0.708784 cov=0.545 section=中文复杂检索文档 > 关键材料
  - rank 4: `zh_doc_080.md::c0002` score=0.700852 cov=0.22 section=中文复杂检索文档 > 背景材料1
  - rank 5: `zh_doc_080.md::c0008` score=0.671362 cov=0.487 section=中文复杂检索文档 > 背景材料2
...
### zh087_holdout — zh_long_span_boundary_candidate
- question: 晾衣架是用什么材料做的
- gold: `zh_doc_087.md > 关键材料`
- best_topk_coverage: 0.542
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_087.md::c0006` score=0.717445 cov=0.542 section=中文复杂检索文档 > 关键材料
  - rank 2: `zh_doc_087.md::c0008` score=0.670351 cov=0.131 section=中文复杂检索文档 > 关键材料
  - rank 3: `zh_doc_087.md::c0004` score=0.642786 cov=0.137 section=中文复杂检索文档 > 背景材料1
  - rank 4: `zh_doc_087.md::c0005` score=0.618767 cov=0.128 section=中文复杂检索文档 > 背景材料2
  - rank 5: `zh_doc_087.md::c0010` score=0.599533 cov=0.208 section=中文复杂检索文档 > 补充材料2

### zh088_holdout — zh_long_span_boundary_candidate
- question: 怎样把嘴唇的颜色遮住
- gold: `zh_doc_088.md > 关键材料`
- best_topk_coverage: 0.605
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_088.md::c0002` score=0.670817 cov=0.554 section=中文复杂检索文档 > 背景材料2
  - rank 2: `zh_doc_088.md::c0001` score=0.654773 cov=0.177 section=中文复杂检索文档 > 背景材料1
  - rank 3: `zh_doc_088.md::c0003` score=0.631575 cov=0.605 section=中文复杂检索文档 > 关键材料
  - rank 4: `zh_doc_088.md::c0000` score=0.619626 cov=0.12 section=
  - rank 5: `zh_doc_088.md::c0006` score=0.601031 cov=0.144 section=中文复杂检索文档 > 补充材料1
...
### zh099_holdout — zh_long_span_boundary_candidate
- question: 水土流失指的是什么
- gold: `zh_doc_099.md > 关键材料`
- best_topk_coverage: 0.626
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_099.md::c0022` score=0.710075 cov=0.471 section=中文复杂检索文档 > 背景材料2
  - rank 2: `zh_doc_099.md::c0000` score=0.665676 cov=0.147 section=
  - rank 3: `zh_doc_099.md::c0023` score=0.664672 cov=0.626 section=中文复杂检索文档 > 关键材料
  - rank 4: `zh_doc_099.md::c0029` score=0.663433 cov=0.491 section=中文复杂检索文档 > 补充材料2
  - rank 5: `zh_doc_099.md::c0024` score=0.646843 cov=0.338 section=中文复杂检索文档 > 关键材料
...
### zh106_holdout — zh_long_span_boundary_candidate
- question: 原地跑步可以瘦肚子吗
- gold: `zh_doc_106.md > 关键材料`
- best_topk_coverage: 0.361
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_106.md::c0003` score=0.714926 cov=0.361 section=中文复杂检索文档 > 关键材料
  - rank 2: `zh_doc_106.md::c0001` score=0.711525 cov=0.196 section=中文复杂检索文档 > 背景材料2
  - rank 3: `zh_doc_106.md::c0012` score=0.701076 cov=0.058 section=中文复杂检索文档 > 补充材料1
  - rank 4: `zh_doc_106.md::c0016` score=0.691129 cov=0.082 section=中文复杂检索文档 > 补充材料2
  - rank 5: `zh_doc_106.md::c0009` score=0.686886 cov=0.058 section=中文复杂检索文档 > 补充材料1
...
### zh112_holdout — zh_long_span_boundary_candidate
- question: QQ图片无法打开是什么原因
- gold: `zh_doc_112.md > 关键材料`
- best_topk_coverage: 0.613
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_112.md::c0004` score=0.760517 cov=0.35 section=中文复杂检索文档 > 关键材料
  - rank 2: `zh_doc_112.md::c0007` score=0.738152 cov=0.085 section=中文复杂检索文档 > 补充材料2
  - rank 3: `zh_doc_112.md::c0001` score=0.725628 cov=0.103 section=中文复杂检索文档 > 背景材料1
  - rank 4: `zh_doc_112.md::c0006` score=0.725385 cov=0.1 section=中文复杂检索文档 > 补充材料1
  - rank 5: `zh_doc_112.md::c0003` score=0.720836 cov=0.613 section=中文复杂检索文档 > 关键材料
...
### zh119_holdout — zh_long_span_boundary_candidate
- question: Clara在神秘博士中是什么角色
- gold: `zh_doc_119.md > 关键材料`
- best_topk_coverage: 0.534
- best_gold_rank_hint: 1
- top results:
  - rank 1: `zh_doc_119.md::c0003` score=0.771267 cov=0.534 section=中文复杂检索文档 > 背景材料2
  - rank 2: `zh_doc_119.md::c0002` score=0.710826 cov=0.391 section=中文复杂检索文档 > 背景材料2
  - rank 3: `zh_doc_119.md::c0000` score=0.702799 cov=0.045 section=
  - rank 4: `zh_doc_119.md::c0001` score=0.653686 cov=0.041 section=中文复杂检索文档 > 背景材料1
  - rank 5: `zh_doc_119.md::c0007` score=0.530933 cov=0.045 section=中文复杂检索文档 > 补充材料2
...
| zh015_holdout | zh_long_span_boundary_candidate | False | None | 0.462 | 1 |
...
| zh021_holdout | zh_long_span_boundary_candidate | False | None | 0.325 | 1 |
...
| zh026_holdout | zh_long_span_boundary_candidate | False | None | 0.487 | 1 |
...
| zh035_holdout | zh_long_span_boundary_candidate | False | None | 0.394 | 1 |
...
| zh042_holdout | zh_long_span_boundary_candidate | False | None | 0.411 | 1 |
...
| zh045_holdout | zh_long_span_boundary_candidate | False | None | 0.521 | 1 |
...
| zh049_holdout | zh_long_span_boundary_candidate | False | None | 0.583 | 1 |
...
| zh052_holdout | zh_long_span_boundary_candidate | False | None | 0.482 | 1 |
...
| zh060_holdout | zh_long_span_boundary_candidate | False | None | 0.27 | 1 |
| zh061_holdout | zh_long_span_boundary_candidate | False | None | 0.342 | 1 |
| zh062_holdout | zh_long_span_boundary_candidate | False | None | 0.506 | 1 |
| zh063_holdout | zh_long_span_boundary_candidate | False | None | 0.526 | 1 |
| zh064_holdout | zh_long_span_boundary_candidate | False | None | 0.639 | 1 |
| zh065_holdout | zh_long_span_boundary_candidate | False | None | 0.581 | 1 |
...
| zh068_holdout | zh_long_span_boundary_candidate | False | None | 0.553 | 1 |
| zh069_holdout | zh_long_span_boundary_candidate | False | None | 0.24 | 1 |
...
| zh073_holdout | zh_long_span_boundary_candidate | False | None | 0.534 | 1 |
...
| zh080_holdout | zh_long_span_boundary_candidate | False | None | 0.545 | 1 |
...
| zh087_holdout | zh_long_span_boundary_candidate | False | None | 0.542 | 1 |
| zh088_holdout | zh_long_span_boundary_candidate | False | None | 0.605 | 1 |
...
| zh099_holdout | zh_long_span_boundary_candidate | False | None | 0.626 | 1 |
...
| zh106_holdout | zh_long_span_boundary_candidate | False | None | 0.361 | 1 |
...
| zh112_holdout | zh_long_span_boundary_candidate | False | None | 0.613 | 1 |
...
| zh119_holdout | zh_long_span_boundary_candidate | False | None | 0.534 | 1 |
